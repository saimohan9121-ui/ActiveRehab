...
import FAQSection, { defaultFaqs } from './landing/FAQSection';
...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 overflow-x-hidden font-sans pb-16 md:pb-0">
      ...
      {/* 01. Header */}
      <LandingHeader onBookRequest={openMobileModal} />
      ...
      {/* 05. Conditions Grid */}
      <ConditionsGrid onBookRequest={openMobileModal} />
      ...
      {/* 10. FAQ Section (DOM-rendered accordions) */}
